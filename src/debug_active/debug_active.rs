...
pub type LPTIM0_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEBUG_ACTIVE_SPEC, bool, O>;
...
pub type LPTIM1_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEBUG_ACTIVE_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - desc LPTIM0"]
    #[inline(always)]
    pub fn lptim0(&self) -> LPTIM0_R {
        LPTIM0_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - desc TIM4"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - desc LPTIM1"]
    #[inline(always)]
    pub fn lptim1(&self) -> LPTIM1_R {
        LPTIM1_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 3 - desc LPTIM0"]
    #[inline(always)]
    pub fn lptim0(&mut self) -> LPTIM0_W<3> {
        LPTIM0_W::new(self)
    }
    #[doc = "Bit 4 - desc TIM4"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - desc LPTIM1"]
    #[inline(always)]
    pub fn lptim1(&mut self) -> LPTIM1_W<12> {
        LPTIM1_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
