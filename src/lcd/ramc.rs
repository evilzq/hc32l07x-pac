#[doc = "Register `RAMC` reader"]
pub struct R(crate::R<RAMC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAMC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAMC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAMC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAMC` writer"]
pub struct W(crate::W<RAMC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAMC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAMC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAMC_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "desc RAMC\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ramc](index.html) module"]
pub struct RAMC_SPEC;
impl crate::RegisterSpec for RAMC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ramc::R](R) reader structure"]
impl crate::Readable for RAMC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ramc::W](W) writer structure"]
impl crate::Writable for RAMC_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RAMC to value 0"]
impl crate::Resettable for RAMC_SPEC {
    #[inline(always)]
