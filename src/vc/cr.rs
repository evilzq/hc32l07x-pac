...
#[doc = "Field `VC2_BIAS_SEL` reader - desc VC2_BIAS_SEL"]
pub type VC2_BIAS_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `VC2_BIAS_SEL` writer - desc VC2_BIAS_SEL"]
pub type VC2_BIAS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 2, O>;
#[doc = "Field `VC2_HYS_SEL` reader - desc VC2_HYS_SEL"]
pub type VC2_HYS_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `VC2_HYS_SEL` writer - desc VC2_HYS_SEL"]
pub type VC2_HYS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 16:17 - desc VC2_BIAS_SEL"]
    #[inline(always)]
    pub fn vc2_bias_sel(&self) -> VC2_BIAS_SEL_R {
        VC2_BIAS_SEL_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 18:19 - desc VC2_HYS_SEL"]
    #[inline(always)]
    pub fn vc2_hys_sel(&self) -> VC2_HYS_SEL_R {
        VC2_HYS_SEL_R::new(((self.bits >> 18) & 3) as u8)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 16:17 - desc VC2_BIAS_SEL"]
    #[inline(always)]
    pub fn vc2_bias_sel(&mut self) -> VC2_BIAS_SEL_W<16> {
        VC2_BIAS_SEL_W::new(self)
    }
    #[doc = "Bits 18:19 - desc VC2_HYS_SEL"]
    #[inline(always)]
    pub fn vc2_hys_sel(&mut self) -> VC2_HYS_SEL_W<18> {
        VC2_HYS_SEL_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
