...
#[doc = "Field `VC2_INTF` reader - desc VC2_INTF"]
pub type VC2_INTF_R = crate::BitReader<bool>;
#[doc = "Field `VC2_INTF` writer - desc VC2_INTF"]
pub type VC2_INTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFR_SPEC, bool, O>;
#[doc = "Field `VC2_FILTER` reader - desc VC2_FILTER"]
pub type VC2_FILTER_R = crate::BitReader<bool>;
...
impl R {
    ...
    #[doc = "Bit 4 - desc VC2_INTF"]
    #[inline(always)]
    pub fn vc2_intf(&self) -> VC2_INTF_R {
        VC2_INTF_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - desc VC2_FILTER"]
    #[inline(always)]
    pub fn vc2_filter(&self) -> VC2_FILTER_R {
        VC2_FILTER_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 4 - desc VC2_INTF"]
    #[inline(always)]
    pub fn vc2_intf(&mut self) -> VC2_INTF_W<4> {
        VC2_INTF_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
