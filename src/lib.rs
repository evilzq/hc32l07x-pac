#![doc = "Peripheral access API for HDSC_HC32L07X microcontrollers (generated using svd2rust v0.24.1 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
extern "C" {
    fn PORTA_IRQHANDLER();
    fn PORTB_IRQHANDLER();
    fn PORTC_E_IRQHANDLER();
    fn PORTD_F_IRQHANDLER();
    fn DMAC_IRQHANDLER();
    fn TIM3_IRQHANDLER();
    fn UART0_2_IRQHANDLER();
    fn UART1_3_IRQHANDLER();
    fn LPUART0_IRQHANDLER();
    fn LPUART1_IRQHANDLER();
    fn SPI0_I2S0_IRQHANDLER();
    fn SPI1_I2S1_IRQHANDLER();
    fn I2C0_IRQHANDLER();
    fn I2C1_IRQHANDLER();
    fn TIM0_IRQHANDLER();
    fn TIM1_IRQHANDLER();
    fn TIM2_IRQHANDLER();
    fn LPTIM0_1_IRQHANDLER();
    fn TIM4_IRQHANDLER();
    fn TIM5_IRQHANDLER();
    fn TIM6_IRQHANDLER();
    fn PCA_IRQHANDLER();
    fn WDT_IRQHANDLER();
    fn RTC_IRQHANDLER();
    fn ADC_DAC_IRQHANDLER();
    fn PCNT_IRQHANDLER();
    fn VC0_1_2_LVD_IRQHANDLER();
    fn USBFS_IRQHANDLER();
    fn CAN_IRQHANDLER();
    fn LCD_IRQHANDLER();
    fn FLASH_RAM_IRQHANDLER();
    fn CLKTRIM_CTS_IRQHANDLER();
}
#[doc(hidden)]
pub union Vector {
...
pub static __INTERRUPTS: [Vector; 48] = [
    ...
    Vector {
        _handler: PORTC_E_IRQHANDLER,
    },
    Vector {
        _handler: PORTD_F_IRQHANDLER,
    },
    Vector {
    ...
    Vector {
        _handler: UART0_2_IRQHANDLER,
    },
    Vector {
        _handler: UART1_3_IRQHANDLER,
    },
    Vector {
    ...
    Vector {
        _handler: SPI0_I2S0_IRQHANDLER,
    },
    Vector {
        _handler: SPI1_I2S1_IRQHANDLER,
    },
    Vector {
    ...
    Vector {
        _handler: LPTIM0_1_IRQHANDLER,
    },
    Vector {
        _handler: TIM4_IRQHANDLER,
    },
    Vector {
        _handler: TIM5_IRQHANDLER,
    },
    Vector {
        _handler: TIM6_IRQHANDLER,
    },
    Vector {
    ...
    Vector {
        _handler: ADC_DAC_IRQHANDLER,
    },
    Vector {
        _handler: PCNT_IRQHANDLER,
    },
    Vector {
        _handler: VC0_1_2_LVD_IRQHANDLER,
    },
    Vector {
        _handler: USBFS_IRQHANDLER,
    },
    Vector {
        _handler: CAN_IRQHANDLER,
    },
    Vector {
    ...
    Vector {
        _handler: CLKTRIM_CTS_IRQHANDLER,
    },
];
...
impl CAN {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const can::RegisterBlock = 0x4003_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
unsafe impl Send for CTS {}
impl CTS {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const cts::RegisterBlock = 0x4000_5000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const cts::RegisterBlock {
        Self::PTR
    }
}
impl Deref for CTS {
    type Target = cts::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for CTS {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTS").finish()
    }
}
#[doc = "desc CTS"]
pub mod cts;
...
impl DAC {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const dac::RegisterBlock = 0x4000_2500 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl I2S0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s0::RegisterBlock = 0x4000_2800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl I2S1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s0::RegisterBlock = 0x4000_2c00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const i2s0::RegisterBlock {
        Self::PTR
...
unsafe impl Send for LPTIMER0 {}
impl LPTIMER0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const lptimer0::RegisterBlock = 0x4000_0f00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const lptimer0::RegisterBlock {
        Self::PTR
    }
}
impl Deref for LPTIMER0 {
    type Target = lptimer0::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
...
impl LPTIMER1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const lptimer0::RegisterBlock = 0x4000_0f40 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const lptimer0::RegisterBlock {
        Self::PTR
...
impl UART2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const uart0::RegisterBlock = 0x4000_6000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const uart0::RegisterBlock {
        Self::PTR
...
impl UART3 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const uart0::RegisterBlock = 0x4000_6400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const uart0::RegisterBlock {
        Self::PTR
...
impl USBFS {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usbfs::RegisterBlock = 0x4004_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
