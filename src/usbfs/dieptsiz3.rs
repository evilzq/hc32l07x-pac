...
#[doc = "Field `MC` reader - desc MC"]
pub type MC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MC` writer - desc MC"]
pub type MC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ3_SPEC, u8, u8, 2, O>;
impl R {
