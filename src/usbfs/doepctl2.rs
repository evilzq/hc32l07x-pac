...
pub type MPSIZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOEPCTL2_SPEC, u8, u8, 2, O>;
...
pub type SD0PID_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL2_SPEC, bool, O>;
#[doc = "Field `SD1PID` reader - desc SD1PID"]
pub type SD1PID_R = crate::BitReader<bool>;
#[doc = "Field `SD1PID` writer - desc SD1PID"]
pub type SD1PID_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPCTL2_SPEC, bool, O>;
