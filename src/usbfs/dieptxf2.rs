...
pub type INEPTXSA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTXF2_SPEC, u16, u16, 12, O>;
...
pub type INEPTXFD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTXF2_SPEC, u16, u16, 10, O>;
impl R {
...
#[doc = "`reset()` method sets DIEPTXF2 to value 0x0100_0240"]
