...
pub type IEPINT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `OEPINT` reader - desc OEPINT"]
pub type OEPINT_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:5 - desc IEPINT"]
    #[inline(always)]
    pub fn iepint(&self) -> IEPINT_R {
        IEPINT_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - desc OEPINT"]
    #[inline(always)]
    pub fn oepint(&self) -> OEPINT_R {
        OEPINT_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
}
