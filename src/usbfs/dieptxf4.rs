...
pub type INEPTXSA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTXF4_SPEC, u16, u16, 12, O>;
...
pub type INEPTXFD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTXF4_SPEC, u16, u16, 10, O>;
impl R {
    #[doc = "Bits 0:11 - desc INEPTXSA"]
    #[inline(always)]
    pub fn ineptxsa(&self) -> INEPTXSA_R {
        INEPTXSA_R::new((self.bits & 0x0fff) as u16)
    }
    #[doc = "Bits 16:25 - desc INEPTXFD"]
    #[inline(always)]
    pub fn ineptxfd(&self) -> INEPTXFD_R {
        INEPTXFD_R::new(((self.bits >> 16) & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - desc INEPTXSA"]
...
#[doc = "`reset()` method sets DIEPTXF4 to value 0x0100_0240"]
