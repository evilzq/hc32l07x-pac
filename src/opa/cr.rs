...
pub type CLK_SW_SET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
#[doc = "Field `CLK_SEL` reader - desc CLK_SEL"]
pub type CLK_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CLK_SEL` writer - desc CLK_SEL"]
pub type CLK_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 4, O>;
impl R {
