...
#[doc = "Field `LPTIM0_G` reader - desc LPTIM0_G"]
pub type LPTIM0_G_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPTIM0_G` writer - desc LPTIM0_G"]
pub type LPTIM0_G_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMGS_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[doc = "Bits 12:14 - desc LPTIM0_G"]
    #[inline(always)]
    pub fn lptim0_g(&self) -> LPTIM0_G_R {
        LPTIM0_G_R::new(((self.bits >> 12) & 7) as u8)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 12:14 - desc LPTIM0_G"]
    #[inline(always)]
    pub fn lptim0_g(&mut self) -> LPTIM0_G_W<12> {
        LPTIM0_G_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
