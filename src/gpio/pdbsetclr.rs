...
pub type PDBCLR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PDBCLR` writer - desc PDBCLR"]
pub type PDBCLR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDBSETCLR_SPEC, u16, u16, 16, O>;
#[doc = "Field `PDBSET` reader - desc PDBSET"]
pub type PDBSET_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PDBSET` writer - desc PDBSET"]
pub type PDBSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PDBSETCLR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - desc PDBCLR"]
    #[inline(always)]
    pub fn pdbclr(&self) -> PDBCLR_R {
        PDBCLR_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - desc PDBSET"]
    #[inline(always)]
    pub fn pdbset(&self) -> PDBSET_R {
        PDBSET_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - desc PDBCLR"]
