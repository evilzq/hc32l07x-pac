...
#[doc = "Field `LPTIM0_E` reader - desc LPTIM0_E"]
pub type LPTIM0_E_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPTIM0_E` writer - desc LPTIM0_E"]
pub type LPTIM0_E_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMES_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[doc = "Bits 12:14 - desc LPTIM0_E"]
    #[inline(always)]
    pub fn lptim0_e(&self) -> LPTIM0_E_R {
        LPTIM0_E_R::new(((self.bits >> 12) & 7) as u8)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 12:14 - desc LPTIM0_E"]
    #[inline(always)]
    pub fn lptim0_e(&mut self) -> LPTIM0_E_W<12> {
        LPTIM0_E_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
