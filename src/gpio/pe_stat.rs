#[doc = "Register `PE_STAT` reader"]
pub struct R(crate::R<PE_STAT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PE_STAT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PE_STAT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PE_STAT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "desc PE_STAT\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pe_stat](index.html) module"]
pub struct PE_STAT_SPEC;
impl crate::RegisterSpec for PE_STAT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pe_stat::R](R) reader structure"]
impl crate::Readable for PE_STAT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PE_STAT to value 0"]
impl crate::Resettable for PE_STAT_SPEC {
    #[inline(always)]
