#[doc = "Register `PDPD` reader"]
pub struct R(crate::R<PDPD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDPD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PDPD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDPD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PDPD` writer"]
pub struct W(crate::W<PDPD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PDPD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PDPD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PDPD_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "desc PDPD\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pdpd](index.html) module"]
pub struct PDPD_SPEC;
impl crate::RegisterSpec for PDPD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pdpd::R](R) reader structure"]
impl crate::Readable for PDPD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pdpd::W](W) writer structure"]
impl crate::Writable for PDPD_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PDPD to value 0xffff_ffff"]
impl crate::Resettable for PDPD_SPEC {
    #[inline(always)]
