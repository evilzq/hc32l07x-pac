...
#[doc = "Field `LPTIM1_G` reader - desc LPTIM1_G"]
pub type LPTIM1_G_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPTIM1_G` writer - desc LPTIM1_G"]
pub type LPTIM1_G_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCAS_SPEC, u8, u8, 3, O>;
#[doc = "Field `LPTIM1_E` reader - desc LPTIM1_E"]
pub type LPTIM1_E_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LPTIM1_E` writer - desc LPTIM1_E"]
pub type LPTIM1_E_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCAS_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[doc = "Bits 6:8 - desc LPTIM1_G"]
    #[inline(always)]
    pub fn lptim1_g(&self) -> LPTIM1_G_R {
        LPTIM1_G_R::new(((self.bits >> 6) & 7) as u8)
    }
    #[doc = "Bits 9:11 - desc LPTIM1_E"]
    #[inline(always)]
    pub fn lptim1_e(&self) -> LPTIM1_E_R {
        LPTIM1_E_R::new(((self.bits >> 9) & 7) as u8)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 6:8 - desc LPTIM1_G"]
    #[inline(always)]
    pub fn lptim1_g(&mut self) -> LPTIM1_G_W<6> {
        LPTIM1_G_W::new(self)
    }
    #[doc = "Bits 9:11 - desc LPTIM1_E"]
    #[inline(always)]
    pub fn lptim1_e(&mut self) -> LPTIM1_E_W<9> {
        LPTIM1_E_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
