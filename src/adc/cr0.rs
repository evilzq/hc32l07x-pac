...
#[doc = "Field `CHMAP` reader - desc CHMAP"]
pub type CHMAP_R = crate::BitReader<bool>;
#[doc = "Field `CHMAP` writer - desc CHMAP"]
pub type CHMAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR0_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 1 - desc CHMAP"]
    #[inline(always)]
    pub fn chmap(&self) -> CHMAP_R {
        CHMAP_R::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - desc CHMAP"]
    #[inline(always)]
    pub fn chmap(&mut self) -> CHMAP_W<1> {
        CHMAP_W::new(self)
    }
    #[doc = "Bits 2:3 - desc CLKDIV"]
    #[inline(always)]
