...
#[doc = "Field `USB48MSEL` reader - desc USB48MSEL"]
pub type USB48MSEL_R = crate::BitReader<bool>;
#[doc = "Field `USB48MSEL` writer - desc USB48MSEL"]
pub type USB48MSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYSCTRL1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 12 - desc USB48MSEL"]
    #[inline(always)]
    pub fn usb48msel(&self) -> USB48MSEL_R {
        USB48MSEL_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 12 - desc USB48MSEL"]
    #[inline(always)]
    pub fn usb48msel(&mut self) -> USB48MSEL_W<12> {
        USB48MSEL_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
