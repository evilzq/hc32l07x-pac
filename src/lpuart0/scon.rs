...
pub type OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `OVER` writer - desc OVER"]
pub type OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCON_SPEC, u8, u8, 2, O>;
#[doc = "Field `SCLKSEL` reader - desc SCLKSEL"]
pub type SCLKSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCLKSEL` writer - desc SCLKSEL"]
pub type SCLKSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCON_SPEC, u8, u8, 2, O>;
...
pub type HDSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCON_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bits 11:12 - desc SCLKSEL"]
    #[inline(always)]
    pub fn sclksel(&self) -> SCLKSEL_R {
        SCLKSEL_R::new(((self.bits >> 11) & 3) as u8)
    }
    ...
    #[doc = "Bit 22 - desc HDSEL"]
    #[inline(always)]
    pub fn hdsel(&self) -> HDSEL_R {
        HDSEL_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 11:12 - desc SCLKSEL"]
    #[inline(always)]
    pub fn sclksel(&mut self) -> SCLKSEL_W<11> {
        SCLKSEL_W::new(self)
    }
    #[doc = "Bit 13 - desc PEIE"]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - desc HDSEL"]
    #[inline(always)]
    pub fn hdsel(&mut self) -> HDSEL_W<22> {
        HDSEL_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
