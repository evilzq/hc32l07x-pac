...
pub type DHR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR8R1_SPEC, u8, u8, 8, O>;
#[doc = "Field `RSV` reader - desc RSV"]
pub type RSV_R = crate::BitReader<bool>;
#[doc = "Field `RSV` writer - desc RSV"]
pub type RSV_W<'a, const O: u8> = crate::BitWriter<'a, u32, DHR8R1_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:7 - desc DHR1"]
    #[inline(always)]
    pub fn dhr1(&self) -> DHR1_R {
        DHR1_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
